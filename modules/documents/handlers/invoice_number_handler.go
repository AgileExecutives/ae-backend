...
// @Success 200 {object} map[string]interface{}{success=bool,organization_id=int,year=int,month=int,current_sequence=int}
// @Failure 400 {object} handlers.ErrorResponse
// @Failure 401 {object} handlers.ErrorResponse
// @Failure 500 {object} handlers.ErrorResponse
...
// @Success 200 {object} map[string]interface{}{success=bool,data=[]entities.InvoiceNumberLog,total=int,page=int,page_size=int}
// @Failure 400 {object} handlers.ErrorResponse
// @Failure 401 {object} handlers.ErrorResponse
// @Failure 500 {object} handlers.ErrorResponse
