...
func TestGenerateToken(t *testing.T) {
	...
	service := services.services.NewBookingLinkService(nil, secret)
...
func TestValidateToken(t *testing.T) {
	secret := "test-secret-key"
	service := services.NewBookingLinkService(nil, secret)
...
func TestInvalidTokenFormat(t *testing.T) {
	service := services.NewBookingLinkService(nil, "test-secret")
