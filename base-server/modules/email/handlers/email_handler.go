...
// RegisterRoutes registers email-related routes
...
func (h *EmailHandler) GetSwaggerTags() []string {
...
func (h *EmailHandler) SendEmail(c *gin.Context) {
	...
	go func() {
		textBody := req.Body
		if textBody == "" {
			// If no text body provided, use a simple conversion from HTML or use subject
		...
		h.db.Model(&email).Updates(models.Email{
			Status:       status,
