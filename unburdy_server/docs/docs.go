...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.CreateInvoiceFromSessionsRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_unburdy_unburdy-server-api_modules_client_management_entities.UpdateInvoiceRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "delete": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Bad Request",
                        "schema": {
                            "$ref": "#/definitions/github_com_unburdy_documents-module_handlers.ErrorResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_unburdy_invoice-module_entities.CreateInvoiceRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/github_com_unburdy_invoice-module_entities.InvoiceResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/entities.CreateDraftInvoiceRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/invoices/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/entities.UpdateDraftInvoiceRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "delete": {
                ...
                "operationId": "cancelDraftInvoice",
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Invoice ID",
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/entities.CreateCreditNoteRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/invoices/{id}/mark-overdue": {
            "post": {
                ...
                "operationId": "markInvoiceAsOverdue",
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Invoice ID",
        ...
        "/settings/health": {
            "get": {
                ...
                "operationId": "settingsHealthCheck",
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
        ...
        "/settings/modules": {
            "get": {
                ...
                "operationId": "getRegisteredModules",
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/entities.ModuleListResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
        ...
        "/settings/organizations/{organization_id}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/entities.SettingsResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "post": {
                ...
                "operationId": "setOrganizationSetting",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Organization ID",
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/entities.SettingRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/entities.SettingResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/settings/organizations/{organization_id}/bulk": {
            "post": {
                ...
                "operationId": "bulkSetOrganizationSettings",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Organization ID",
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/entities.BulkSettingRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/entities.DomainResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
        ...
        "/settings/organizations/{organization_id}/domains/{domain}": {
            "get": {
                ...
                "operationId": "getOrganizationDomainSettings",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Organization ID",
            ...
            "post": {
                ...
                "operationId": "setOrganizationDomainSettings",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Organization ID",
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/entities.DomainSettingsRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "delete": {
                ...
                "operationId": "deleteOrganizationDomainSettings",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Organization ID",
        ...
        "/settings/organizations/{organization_id}/export": {
            "get": {
                ...
                "operationId": "exportOrganizationSettings",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Organization ID",
        ...
        "/settings/organizations/{organization_id}/import": {
            "post": {
                ...
                "operationId": "importOrganizationSettings",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Organization ID",
        ...
        "/settings/organizations/{organization_id}/validate": {
            "post": {
                ...
                "operationId": "validateOrganizationSettings",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Organization ID",
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/entities.ValidationRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/entities.ValidationResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/settings/version": {
            "get": {
                ...
                "operationId": "getSettingsVersion",
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
    ...
    "definitions": {
        ...
        "entities.InvoiceAPIResponse": {
            ...
            "properties": {
                "data": {
                    "$ref": "#/definitions/github_com_unburdy_unburdy-server-api_modules_client_management_entities.InvoiceResponse"
                },
                "message": {
                    "type": "string",
        ...
        "entities.VATBreakdownResponse": {
            ...
            "properties": {
                ...
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/entities.VATBreakdownItemResponse"
                    }
                },
                "subtotal": {
                    "type": "number"
        ...
        "github_com_unburdy_invoice-module_entities.InvoiceStatus": {
            "type": "string",
            "enum": [
                "draft",
                "sent",
        ...
        "github_com_unburdy_unburdy-server-api_modules_client_management_entities.InvoiceResponse": {
            ...
            "properties": {
                ...
                "status": {
                    "$ref": "#/definitions/github_com_unburdy_unburdy-server-api_modules_client_management_entities.InvoiceStatus"
                },
                "sum_amount": {
                    "type": "number"
                },
                ...
                "vat_breakdown": {
                    "$ref": "#/definitions/entities.VATBreakdownResponse"
                }
            }
        },
        "github_com_unburdy_unburdy-server-api_modules_client_management_entities.InvoiceStatus": {
            "type": "string",
            "enum": [
                "draft",
                "sent",
    ...
    "tags": [
        ...
        {
            "description": "[Documents Module] Document storage and management with MinIO integration",
            "name": "Documents"
        },
        {
            "description": "[Documents Module] Sequential invoice number generation with Redis caching",
            "name": "Invoice Numbers"
        },
        {
            "description": "[Documents Module] Template management for emails and PDFs with versioning",
            "name": "Templates"
        },
        {
            "description": "[Documents Module] PDF generation from HTML and templates using Chromedp",
            "name": "PDFs"
        },
        {
            "description": "[Audit Module] Audit logging, compliance tracking, and GoBD-compliant export",
            "name": "audit"
        }
    ]
}`
